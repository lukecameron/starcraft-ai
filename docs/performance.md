...
The subsequent [per-search memoization candidate](evaluations/quick-as-memo-v1/RESULT.md), frozen `04521bef…`, completed another ten clean fixed games and all 20 replays parsed successfully. Aggregate throughput was 413.1 fps, but four games remained below 384 and the minimum was 269.5. It therefore also failed the registered gate. Peak candidate-plus-engine RSS was 468.7 MiB. These separate trajectories do not establish a causal improvement over the bounds-only candidate.
