...
Earlier training did not solve exposure. On Benzene the first enemy contact preceded the first completed combat unit by 1,451 frames; on Heartbreak Ridge the gap was 1,333 frames. Kestrel recorded only two simultaneous zealots in each game and lost 16 and 14 probes respectively. The matched candidate ended at local frame 6,265, 62 frames earlier than v7's 6,327, so the directional defense gate failed. The held-out row also failed its registered lifecycle floor of 12 probes and three zealots, reaching 11 and two.
